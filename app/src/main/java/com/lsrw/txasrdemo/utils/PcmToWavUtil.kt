...
object PcmToWavUtil {
    ...
    fun pcmToWav(
        ...
        try {
            fileIn = FileInputStream(inFilename)
            fileOut = FileOutputStream(outFilename)
            totalAudioLen = fileIn.channel.size()
            LogUtils.d("AudioRecorder","totalAudioLen:$totalAudioLen")
            totalDataLen = totalAudioLen + 36
            writeWaveFileHeader(
                fileOut, totalAudioLen, totalDataLen,
